(function () {
  ...
  window.SEEMAX_DEMO_SEED = {
    ...
    settings: {
      ...
      patch_notes_enabled: "SI", patch_notes_frequency: "ONCE", patch_notes_revision: 1, patch_notes_label: "SEEMAX MANAGEMENT SUITE 2.15.0", patch_notes_title: "Operazioni più rapide e sicure", patch_notes_intro: "I salvataggi leggono soltanto le righe necessarie.", patch_notes_items: "⚡|Percorso mirato|Nessuna scansione completa durante i salvataggi ordinari.\n🔢|Contatori atomici|Identificativi pratica protetti per il lavoro simultaneo.\n🛡️|Esito persistente|Le operazioni restano recuperabili dopo un timeout.", patch_notes_footer: "Le viste complete continuano a sincronizzare tutti i dati quando necessario.",
