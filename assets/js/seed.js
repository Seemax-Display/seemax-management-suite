(function () {
  ...
  window.SEEMAX_DEMO_SEED = {
    ...
    practices: [
      { id: "PR-001-26", numero: "001-26", clientId: "cli-demo-1", cliente: "Farmacia Piazza Centro", titolo: "Ledwall P3.91 2×1 m", stato: "Inserita", tipo_pratica: "NOLEGGIO", finanziaria: "Grenke", valore: 6500, agente: "Agente Dimostrativo", scadenza: iso(5), prossimoPasso: "Richiamare il cliente", note: "In attesa di conferma", aggiornatoIl: iso(-1) },
      { id: "PR-002-26", numero: "002-26", clientId: "cli-demo-2", cliente: "Boutique Etna SRL", titolo: "Ledwall P2.5 3,20×1,92 m", stato: "Inserita", tipo_pratica: "LEASING", finanziaria: "IFIS", valore: 10500, agente: "Agente Dimostrativo", scadenza: iso(2), prossimoPasso: "Ricevere visura camerale", note: "Documentazione parziale", aggiornatoIl: iso(-2) },
      { id: "PR-003-26", numero: "003-26", clientId: "cli-demo-3", cliente: "Centro Gomme Demo", titolo: "Sopralluogo e studio fattibilità", stato: "Inserita", tipo_pratica: "ACQUISTO", finanziaria: "Da definire", valore: 0, agente: "Agente Dimostrativo", scadenza: iso(8), prossimoPasso: "Fissare sopralluogo", note: "", aggiornatoIl: iso(0) }
    ],
    documents: [
