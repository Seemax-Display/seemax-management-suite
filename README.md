...
Per aggiornare un'installazione già operativa alla versione 2.7.3 segui [docs/AGGIORNAMENTO_V2.7.3.md](docs/AGGIORNAMENTO_V2.7.3.md). Consulta anche [docs/PROTEZIONE_MULTIUTENTE.md](docs/PROTEZIONE_MULTIUTENTE.md) e l’[audit prestazioni 2.3](docs/AUDIT_PRESTAZIONI_V2.3.md).
