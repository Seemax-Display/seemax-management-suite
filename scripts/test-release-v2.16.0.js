...
check(/version:\s*["']2\.16\.0["']/.test(config), 'frontend 2.16.0');
check(/SEEMAX_VERSION\s*=\s*["']seemax-management-suite-2\.16\.0["']/.test(backend), 'backend 2.16.0');
check(/seemax-management-v2-16-0-release-ready/.test(sw), 'cache PWA 2.16.0');
...
const cleanupSandbox = {
  ...
  SEEMAX_VERSION: 'seemax-management-suite-2.16.0',
...
console.log(`Test rilascio 2.16.0 OK: ${checks} controlli.`);
